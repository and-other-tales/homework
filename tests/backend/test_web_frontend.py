...
class MockWebSocketServer:
    ...
    async def handler(self, websocket, path):
        ...
        welcome_message = {
            "type": "system",
            "content": "Welcome to homework. I can help you create datasets from GitHub repositories and websites.",
...
async def test_chat_interface_messaging(mock_ws_server):
    ...
    async with async_playwright() as p:
        ...
        assert "Welcome to homework" in system_message
...
def test_real_web_ui_integration(xfail=True):
    ...
    try:
        ...
        assert "homework Dashboard" in response.text
